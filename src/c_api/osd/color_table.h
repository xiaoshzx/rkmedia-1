...
/* PixFormat: BGRA => B:bit31~bit24 G:bit23~bit16 R:bit15~bit8 A:bit7~bit0*/
const RK_U32 bgra8888_palette_table[PALETTE_TABLE_LEN] = {
    0xffffffff, 0x000000ff, 0xafffffff, 0x87ffffff, 0x5fffffff, 0x00ffffff,
    ...
    0xff0000ff, 0xd70000ff, 0xaf0000ff, 0x870000ff, 0x5f0000ff, 0xd7ffffff,
...
/* PixFormat: AVUY => A:bit31~bit24 V:bit23~bit16 U:bit15~bit8 Y:bit7~bit0*/
const RK_U32 yuv444_palette_table[PALETTE_TABLE_LEN] = {
    0xff8080eb, 0xff808010, 0xff835de6, 0xff854be4, 0xff863ae1, 0xff8a10db,
    ...
    0xff76f020, 0xff77de1d, 0xff79cd1b, 0xff7bbb18, 0xff7caa16, 0xff826ee9,
...
RK_U8 find_color(const RK_U32 *pal, RK_U32 len, RK_U8 r, RK_U8 g, RK_U8 b);
